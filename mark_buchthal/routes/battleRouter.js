...
var heroLevel, villainLevel, villainPower, heroPower, heroName, villainName, randHero, randVillain;
...
function sendMessage(res) {
  if (heroLevel > villainLevel) {
    res.status(200).send('The ' + heroPower + ' of ' + heroName +
      ' has defeated ' + villainName + ' and their ' + villainPower + '!!');
  } else {
    res.status(200).send('The ' + villainPower + ' of ' + villainName +
      ' has defeated ' + heroName + ' and their ' + heroPower + '!!');
  }
}
